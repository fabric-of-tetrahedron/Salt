...
public class LayeredBakedModel implements BakedModel {
    ...
    public @NotNull List<BakedQuad> getQuadsInner(@Nullable BlockState state, @Nullable Direction side, @NotNull RandomSource rand) {
        List<BakedQuad> quads = new ArrayList<>();

        for (BakedModel layer : layers) {
            List<BakedQuad> layerQuads = layer.getQuads(state, side, rand);
    ...
    public @NotNull List<BakedQuad> getQuads(@Nullable BlockState pState, @Nullable Direction pDirection, @NotNull RandomSource pRandom) {
        return getQuadsInner(pState, pDirection, pRandom);
    }
